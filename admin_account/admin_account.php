...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_profile'])) {
    ...
    $update_query = "UPDATE users SET username = '$new_username', birthday = '$birthday', phone = '$phone', email = '$email', password = '$password', img = '$profile_picture' WHERE username = '$username'";
        ...
        <main>
            ...
            <div class="main-form">
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <!-- <div class="reset-btn flex">
                        <div class="ubah-btn">
                            <button type="submit" name="ubah_email" class="reset">Ubah Email</button>
                        </div>
                        <div class="ubah-btn">
                            <button type="submit" name="ubah_password" class="reset">Ubah Password</button>
                        </div>
                    </div> -->
