...
log_activity($conn, $user_id, 'course', "Memulai course materi 1");

$course_id = $_GET['id_course'];

$query = "SELECT * FROM matter WHERE id_course = '$course_id' AND no_matter = 1";
$result = mysqli_query($conn, $query);
...
if ($video_id) {
    ...
    if (!$checktrue){
        $progres = "25";
        $sql_progres = "INSERT INTO completed_courses (id_user, id_course, progres) VALUES ('$user_id', '$course_id','$progres' )";
    ...
    // $progres_query = "SELECT * FROM completed_courses";
    // $progres_result = mysqli_query($conn, $progres_query);
...
<head>
    ...
    <link rel="stylesheet" href="materi1.css">
    <link rel="icon" href="../assets/favicon.ico" type="image/x-icon">
    <!-- font awesome -->
