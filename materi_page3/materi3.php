...
$query = "SELECT * FROM matter WHERE id_course = '$course_id' AND no_matter = 3";
$result = mysqli_query($conn, $query);
...
<head>
    ...
    <title>Courses | DevSkills</title>
        ...
        <link rel="stylesheet" href="materi3.css">
        <link rel="icon" href="../assets/favicon.ico" type="image/x-icon">
            ...
            <div class="main-content grid">
                ...
                <div class="right-side">
                    ...
                    <a href="../materi_page1/materi1.php?id_course=<?php echo $course_id; ?>">
                        ...
                        <a href="../materi_page4/materi4.php?id_course=<?php echo $course_id; ?>">
                            <div class="level flex">
                                <p>4. Post Test</p>
                                <span class="material-symbols-outlined">
                                    play_arrow
